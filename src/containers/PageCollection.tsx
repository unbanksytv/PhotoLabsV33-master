...
const PageCollection: FC<PageCollectionProps> = ({ className = "" }) => {
  return (
    ...
    >
      <Helmet>
        <title>Photo Labs || NFT Auction House & Art Gallery.</title>
      </Helmet>
          ...
          <div className=" bg-white dark:bg-neutral-900 dark:border dark:border-neutral-700 p-5 lg:p-8 rounded-3xl md:rounded-[40px] shadow-xl flex flex-col md:flex-row lg:items-center">
            ...
            <div className="mt-5 md:mt-0 md:ml-8 xl:ml-14 flex-grow">
              <div className="max-w-screen-sm ">
                <h2 className="inline-block text-2xl sm:text-3xl lg:text-4xl font-bold">
                  {"Photo Labs NFT collection "}
                </h2>
                <span className="block mt-4 text-sm text-neutral-500 dark:text-neutral-400">
                  Good Nouns Vibes is home to 3,333 generative NFTs. They represent the brand DNA 
                  we cultivated over the past 25 years with LiveTheLifeTV. They showcase our passion 
                  for surf, film, photography, etc, ... Now imagine, NounsDAO with some custom tweaks
                </span>
              </div>
      ...
      <div className="container py-16 lg:pb-28 lg:pt-20 space-y-20 lg:space-y-28">
        <main>
          ...
          <div className="flex flex-col mt-12 lg:mt-16 space-y-5 sm:space-y-0 sm:space-x-3 sm:flex-row sm:justify-between sm:items-center">
            <Pagination />
            <ButtonPrimary loading>Show me more ser</ButtonPrimary>
          </div>
        </main>
