...
const plans = [
  {
    name: "Mint Pass - Founder",
    featuredImage: nftsImgs[0],
  },
  {
    name: "Artist - Photography",
    featuredImage: nftsImgs[1],
  },
  {
    name: "Artist - Photogrammetry",
    featuredImage: nftsImgs[2],
  },
  {
    name: "Artist - Cinematography",
    featuredImage: nftsImgs[3],
  },
  {
    name: "Collector - Vested Crew",
    featuredImage: nftsImgs[4],
  },
  {
    name: "Collector - Degen Vibes",
...
const PageUploadItem: FC<PageUploadItemProps> = ({ className = "" }) => {
  ...
  return (
    ...
    >
      <Helmet>
        <title>Create Item || Photo Labs || NFT Auction House & Art Gallery.</title>
      </Helmet>
          ...
          <div className="mt-10 md:mt-0 space-y-5 sm:space-y-6 md:sm:space-y-8">
            <div>
              <h3 className="text-lg sm:text-2xl font-bold">
                Photography, Cinematography, Audio, or Photogrammetry
              </h3>
            ...
            <FormItem
              label="External link"
              desc="Photo Labs will include a link to this URL on this item's detail page, so that users can click to learn more about it. You are welcome to link to your own webpage with more details."
            >
              <div className="flex">
            ...
            <FormItem
              ...
              desc={
                <div>
                  ...
                  <span className="text-yellow-400">Markdown</span> syntax is
                  supported.
                </div>
              }
            >
