...
const SectionHero: FC<SectionHeroProps> = ({
  className = "",
  heading = "Curated drops with fine art photogrammetry",
  subHeading = "The Founders Mint Pass will unlock digital, physical, and experiential benefits for holders. We think of these NFTs as a piece of art that also acts as a Proof Of Membership.",
}) => {
  return (
    <div
    ...
    >
      <div className="flex flex-col lg:flex-row space-y-14 lg:space-y-0 lg:space-x-10 lg:items-center relative">
        <div className="w-screen max-w-full xl:max-w-xl space-y-5 lg:space-y-7">
          <h2 className="text-3xl !leading-tight font-bold text-neutral-900 md:text-4xl xl:text-5xl dark:text-neutral-100">
            {heading}
          </h2>
