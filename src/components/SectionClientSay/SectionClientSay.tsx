...
const DEMO_DATA = [
  {
    id: 1,
    clientName: "Degen Nouns Vibes",
    clientAddress: "MetaVerse",
    content:
      "This art studio is powering the future of meta, digital, and traditional media.",
  },
  {
    id: 2,
    clientName: "Good Vibes Ohmly",
    clientAddress: "0x ... World",
    content:
      "You guys are shaping our brand through storytelling, experiences, and community.",
  },
  {
    id: 3,
...
const SectionClientSay: FC<SectionClientSayProps> = ({ className = "" }) => {
  ...
  return (
    ...
    >
      <Heading desc="Let's see what people think of Photo Labs" isCenter>
